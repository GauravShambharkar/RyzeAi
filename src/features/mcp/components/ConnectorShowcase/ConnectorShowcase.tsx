  ...
  <section className="relative py-24 md:py-32 bg-[#FAF7F2]">
    <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-20">
      <div className="flex items-center gap-3 justify-center">
        ...
        <h2 className="font-display text-3xl md:text-5xl text-neutral-900 tracking-tight text-center">
          What you can do with Claude Connector
        </h2>
      </div>

      <p className="mt-4 text-center text-sm text-neutral-600 max-w-xl mx-auto">
