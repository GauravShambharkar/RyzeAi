      ...
      <div className="rounded-2xl sm:rounded-3xl border border-black/5 bg-white overflow-hidden shadow-[0_8px_32px_-16px_rgba(20,20,20,0.08)]">
        ...
        {keywords.map((kw) => (
          <button
            ...
            className="group w-full grid grid-cols-[1fr_auto_auto] sm:grid-cols-[1fr_auto_auto_auto] gap-x-2.5 sm:gap-x-4 items-center px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 hover:bg-neutral-50/70 transition-colors border-b border-black/5 last:border-b-0 text-left"
          >
            <span className="font-mono text-[11px] sm:text-xs md:text-sm text-neutral-800 truncate group-hover:text-emerald-700 transition-colors min-w-0">
              {kw.keyword}
            </span>
            <span
              className={`font-mono text-[11px] sm:text-xs md:text-sm tabular-nums font-medium ${
                kw.position <= 3
                  ? "text-emerald-700"
                  : kw.position <= 10
                    ? "text-neutral-900"
            ...
            <span className="inline-flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-xs font-mono tabular-nums text-neutral-600">
        ...
        <div className="px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 text-[9px] sm:text-[10px] text-neutral-500 flex items-center justify-between gap-2 bg-neutral-50/50 border-t border-black/5">
          <span className="truncate">Tap a keyword — agent drafts a rank plan.</span>
