    ...
    <div ref={ref} className="relative">
      ...
      >
        ...
        {active && activeCount > 0 && (
          <span className="inline-flex items-center gap-0.5 rounded-full bg-emerald-500/10 text-emerald-700 px-1.5 text-[10px] font-medium tabular-nums">
      ...
      {open && (
        <div className="absolute left-0 bottom-full mb-2 min-w-[280px] rounded-2xl border border-black/5 bg-white shadow-[0_20px_60px_-16px_rgba(20,20,20,0.2)] overflow-hidden z-20">
          ...
          {properties.length === 0 ? (
            ...
            <div className="max-h-64 overflow-y-auto scrollbar-chat">
              {properties.map((p) => {
