...
export const BrowserFrame = ({ activeTab, onSelectTab }: Props) => (
  <div className="bg-neutral-100 border-b border-black/5 p-2.5 flex flex-col gap-2.5 shrink-0">
    ...
    <div className="flex items-center gap-3 px-1">
      <div className="flex items-center gap-3 text-neutral-400">
        <ArrowLeft size={14} className="cursor-pointer hover:text-neutral-700 transition-colors" />
        <ArrowRight size={14} className="cursor-pointer hover:text-neutral-700 transition-colors" />
        <RefreshCw size={12} className="cursor-pointer hover:text-neutral-700 transition-colors" />
      </div>
      <div className="flex-1 bg-white rounded-full px-3 py-0.5 flex items-center gap-2 border border-black/5">
